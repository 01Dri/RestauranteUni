        ...
        private static void SeedRestaurants(EntityTypeBuilder<Restaurant> builder)
        {
            builder.HasData(
                new Restaurant
                {
                    ...
                    Email = new Email("ru@RaizesDoNordeste.com"),
                ...
                new Restaurant
                {
                    ...
                    Email = new Email("cantina@RaizesDoNordeste.com"),
                ...
                new Restaurant
                {
                    ...
                    Email = new Email("bistro@RaizesDoNordeste.com"),
            ...
            builder.OwnsOne(x => x.Address)
                .HasData(
                    new
                    {
                        RestaurantId = RaizesDoNordesteversitarioId,
